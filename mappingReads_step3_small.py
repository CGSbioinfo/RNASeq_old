...
def alignment(i):
    ...
    if r2:
        ...
        r2 = [trimmedReads[y] for y, x in enumerate(trimmedReads) if re.findall("_R2_.*val_2.fq", x)]
        os.system("STAR --genomeDir " + refGenome + " --readFilesIn trimmedReads/" + r1[0] + " trimmedReads/" + r2[0] + " --runThreadN 4 --outSAMtype BAM SortedByCoordinate --outFilterMismatchNoverLmax 0.05 --outFilterMatchNmin 16 --outFilterScoreMinOverLread 0 --outFilterMatchNminOverLread 0 --alignIntronMax 1 --clip3pAdapterSeq TGGAATTCTC --clip3pAdapterMMp 0.1 --outFileNamePrefix alignedReads/1pass_ann/" + i)
        ...
        os.system("STAR --genomeDir " + refGenome + " --readFilesIn trimmedReads/" + r1[0] + " --runThreadN 8 --outSAMtype BAM SortedByCoordinate --outFilterMismatchNoverLmax 0.05 --outFilterMatchNmin 16 --outFilterScoreMinOverLread 0 --outFilterMatchNminOverLread 0 --alignIntronMax 1 --clip3pAdapterSeq TGGAATTCTC --clip3pAdapterMMp 0.1  --outFileNamePrefix alignedReads/1pass_ann/" + i)
