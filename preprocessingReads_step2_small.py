...
def preprocessing(i):
    ...
    if pairedReads_temp:
        ...
        os.system("trim_galore --small_rna --paired --retain_unpaired --fastqc --output_dir trimmedReads/ " + 'rawReads/' + i + "/" + i + "_R1_*.fastq" + gz + " rawReads/" + i + "/" + i + "_R2_*.fastq" + gz)
        ...
        os.system("trim_galore --small_rna --fastqc --output_dir trimmedReads/ rawReads/" + i + "/" + i + "_R1_*.fastq" + gz)
